...
## Phase 93: 完善營運分析模組匯出報表功能

### jsPDF 整合
- [ ] 安裝 jsPDF 與 html2canvas 套件
- [ ] 實作 Chart.js 圖表轉換為圖片功能
- [ ] 實作將圖片嵌入 PDF 的功能
- [ ] 測試 PDF 生成功能（圖表顯示正確）

### 日期範圍選擇器
- [ ] 安裝 react-day-picker 或使用 shadcn/ui DateRangePicker
- [ ] 在 BiDashboard 新增日期範圍選擇器 UI
- [ ] 將選擇的日期範圍傳遞至匯出 API
- [ ] 測試日期範圍選擇功能

### 匯出進度條
- [ ] 建立 Progress 組件（使用 shadcn/ui）
- [ ] 實作匯出進度追蹤邏輯
- [ ] 在 Dialog 中顯示進度條
- [ ] 測試進度條顯示正確
...
## Phase 94: Dashboard 模組 CRUD 功能完整測試
