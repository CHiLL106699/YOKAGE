    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "border border-[#d4af37]/30 shadow-xl shadow-[#d4af37]/10",
          // 動畫效果
          ...
          "origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl p-1",
          className
        )}
        {...props}
      />
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        // 燙金 hover 效果
        "focus:bg-[#d4af37]/10 focus:text-[#d4af37]",
        ...
        "[&_svg:not([class*='text-'])]:text-[#d4af37]/60",
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CircleIcon className="size-2 fill-[#d4af37] text-[#d4af37]" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-sm font-medium text-[#d4af37] data-[inset]:pl-8",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-[#d4af37]/20 -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-[#d4af37]/50 ml-auto text-xs tracking-widest",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        "focus:bg-[#d4af37]/10 focus:text-[#d4af37]",
        "data-[state=open]:bg-[#d4af37]/10 data-[state=open]:text-[#d4af37]",
        "[&_svg:not([class*='text-'])]:text-[#d4af37]/60",
        "flex cursor-default items-center gap-2 rounded-lg px-2 py-1.5 text-sm outline-hidden select-none",
        "transition-colors duration-150",
